This repository (repo), contains material related to the Northeast Input/Output(I/O) model produced by the Social Sciences Branch. The model was originally developed by Scott Steinback and has since been updated by Greg Ardini, the current POC.

Who worked on this project: Greg Ardini
...
Who maintains and contributes to the project: This repo is maintained by Greg Ardini.
